...
DB_ALLENATORI = {
    ...
    # --- SERIE A ---
    "atalanta": {"allenatore": "Gian Piero Gasperini", "indice_tattico": 9},
    "bologna": {"allenatore": "Vincenzo Italiano", "indice_tattico": 7},
    "cagliari": {"allenatore": "Davide Nicola", "indice_tattico": 5},
    "como": {"allenatore": "Cesc Fàbregas", "indice_tattico": 8},
    "empoli": {"allenatore": "Roberto D'Aversa", "indice_tattico": 5},
    "fiorentina": {"allenatore": "Raffaele Palladino", "indice_tattico": 7},
    "genoa": {"allenatore": "Alberto Gilardino", "indice_tattico": 6},
    "inter": {"allenatore": "Simone Inzaghi", "indice_tattico": 9},
    "juventus": {"allenatore": "Thiago Motta", "indice_tattico": 8},
    "lazio": {"allenatore": "Marco Baroni", "indice_tattico": 7},
    "lecce": {"allenatore": "Luca Gotti", "indice_tattico": 5},
    "milan": {"allenatore": "Paulo Fonseca", "indice_tattico": 7},
    "monza": {"allenatore": "Alessandro Nesta", "indice_tattico": 6},
    "napoli": {"allenatore": "Antonio Conte", "indice_tattico": 9},
    "parma": {"allenatore": "Fabio Pecchia", "indice_tattico": 7},
    "roma": {"allenatore": "Ivan Juric", "indice_tattico": 7},
    "torino": {"allenatore": "Paolo Vanoli", "indice_tattico": 6},
    "udinese": {"allenatore": "Kosta Runjaic", "indice_tattico": 6},
    "venezia": {"allenatore": "Eusebio Di Francesco", "indice_tattico": 6},
    "verona": {"allenatore": "Paolo Zanetti", "indice_tattico": 5},

    # --- SERIE B ---
    "bari": {"allenatore": "Moreno Longo", "indice_tattico": 6},
    "brescia": {"allenatore": "Rolando Maran", "indice_tattico": 6},
    "carrarese": {"allenatore": "Antonio Calabro", "indice_tattico": 5},
    "catanzaro": {"allenatore": "Fabio Caserta", "indice_tattico": 6},
    "cesena": {"allenatore": "Michele Mignani", "indice_tattico": 6},
    "cittadella": {"allenatore": "Edoardo Gorini", "indice_tattico": 5},
    "cosenza": {"allenatore": "Massimiliano Alvini", "indice_tattico": 5},
    "cremonese": {"allenatore": "Giovanni Stroppa", "indice_tattico": 7},
    "frosinone": {"allenatore": "Vincenzo Vivarini", "indice_tattico": 7},
    "juve stabia": {"allenatore": "Guido Pagliuca", "indice_tattico": 6},
    "mantova": {"allenatore": "Davide Possanzini", "indice_tattico": 8},
    "modena": {"allenatore": "Pierpaolo Bisoli", "indice_tattico": 4},
    "palermo": {"allenatore": "Alessio Dionisi", "indice_tattico": 7},
    "pisa": {"allenatore": "Filippo Inzaghi", "indice_tattico": 7},
    "reggiana": {"allenatore": "William Viali", "indice_tattico": 6},
    "salernitana": {"allenatore": "Giovanni Martusciello", "indice_tattico": 6},
    "sampdoria": {"allenatore": "Andrea Sottil", "indice_tattico": 6},
    "sassuolo": {"allenatore": "Fabio Grosso", "indice_tattico": 7},
    "spezia": {"allenatore": "Luca D'Angelo", "indice_tattico": 6},
    "sudtirol": {"allenatore": "Federico Valente", "indice_tattico": 5},

    # --- PREMIER LEAGUE ---
    "arsenal": {"allenatore": "Mikel Arteta", "indice_tattico": 9},
    "aston villa": {"allenatore": "Unai Emery", "indice_tattico": 9},
    "bournemouth": {"allenatore": "Andoni Iraola", "indice_tattico": 8},
    "brentford": {"allenatore": "Thomas Frank", "indice_tattico": 8},
    "brighton": {"allenatore": "Fabian Hürzeler", "indice_tattico": 8},
    "chelsea": {"allenatore": "Enzo Maresca", "indice_tattico": 8},
    "crystal palace": {"allenatore": "Oliver Glasner", "indice_tattico": 8},
    "everton": {"allenatore": "Sean Dyche", "indice_tattico": 4},
    "fulham": {"allenatore": "Marco Silva", "indice_tattico": 7},
    "ipswich": {"allenatore": "Kieran McKenna", "indice_tattico": 7},
    "leicester": {"allenatore": "Steve Cooper", "indice_tattico": 6},
    "liverpool": {"allenatore": "Arne Slot", "indice_tattico": 9},
    "manchester city": {"allenatore": "Pep Guardiola", "indice_tattico": 10},
    "manchester united": {"allenatore": "Erik ten Hag", "indice_tattico": 7},
    "newcastle": {"allenatore": "Eddie Howe", "indice_tattico": 8},
    "nottingham": {"allenatore": "Nuno Espírito Santo", "indice_tattico": 5},
    "southampton": {"allenatore": "Russell Martin", "indice_tattico": 7},
    "tottenham": {"allenatore": "Ange Postecoglou", "indice_tattico": 9},
    "west ham": {"allenatore": "Julen Lopetegui", "indice_tattico": 7},
    "wolves": {"allenatore": "Gary O'Neil", "indice_tattico": 6},

    # --- BUNDESLIGA ---
    "bayern monaco": {"allenatore": "Vincent Kompany", "indice_tattico": 9},
    "borussia": {"allenatore": "Nuri Şahin", "indice_tattico": 8},
    "bayer leverkusen": {"allenatore": "Xabi Alonso", "indice_tattico": 10},
    "lipsia": {"allenatore": "Marco Rose", "indice_tattico": 8},
    "eintracht francoforte": {"allenatore": "Dino Toppmöller", "indice_tattico": 7},
    "wolfsburg": {"allenatore": "Ralph Hasenhüttl", "indice_tattico": 7},
    "borussia monchengladbach": {"allenatore": "Gerardo Seoane", "indice_tattico": 6},
    "friburgo": {"allenatore": "Julian Schuster", "indice_tattico": 6},
    "hoffenheim": {"allenatore": "Pellegrino Matarazzo", "indice_tattico": 7},
    "stoccarda": {"allenatore": "Sebastian Hoeneß", "indice_tattico": 9},
    "werder brema": {"allenatore": "Ole Werner", "indice_tattico": 6},
    "fc augusta": {"allenatore": "Jess Thorup", "indice_tattico": 6},
    "magonza": {"allenatore": "Bo Henriksen", "indice_tattico": 6},
    "union berlino": {"allenatore": "Bo Svensson", "indice_tattico": 5},
    "bochum": {"allenatore": "Peter Zeidler", "indice_tattico": 5},
    "heidenheim": {"allenatore": "Frank Schmidt", "indice_tattico": 6},
    "st. pauli": {"allenatore": "Alexander Blessin", "indice_tattico": 7},
    "holstein kiel": {"allenatore": "Marcel Rapp", "indice_tattico": 6},

    # --- LA LIGA ---
    "real madrid": {"allenatore": "Carlo Ancelotti", "indice_tattico": 9},
    "barcellona": {"allenatore": "Hansi Flick", "indice_tattico": 10},
    "atletico madrid": {"allenatore": "Diego Simeone", "indice_tattico": 7},
    "athletic bilbao": {"allenatore": "Ernesto Valverde", "indice_tattico": 8},
    "girona": {"allenatore": "Míchel", "indice_tattico": 9},
    "real sociedad": {"allenatore": "Imanol Alguacil", "indice_tattico": 8},
    "real betis": {"allenatore": "Manuel Pellegrini", "indice_tattico": 7},
    "villarreal": {"allenatore": "Marcelino", "indice_tattico": 7},
    "valencia": {"allenatore": "Rubén Baraja", "indice_tattico": 5},
    "sevilla": {"allenatore": "García Pimienta", "indice_tattico": 7},
    "alaves": {"allenatore": "Luis García Plaza", "indice_tattico": 5},
    "celta vigo": {"allenatore": "Claudio Giráldez", "indice_tattico": 7},
    "espanyol": {"allenatore": "Manolo González", "indice_tattico": 5},
    "getafe": {"allenatore": "José Bordalás", "indice_tattico": 3},
    "las palmas": {"allenatore": "Luis Carrión", "indice_tattico": 6},
    "leganes": {"allenatore": "Borja Jiménez", "indice_tattico": 5},
    "mallorca": {"allenatore": "Jagoba Arrasate", "indice_tattico": 6},
    "osasuna": {"allenatore": "Vicente Moreno", "indice_tattico": 6},
    "rayo vallecano": {"allenatore": "Iñigo Pérez", "indice_tattico": 6},
    "valladolid": {"allenatore": "Paulo Pezzolano", "indice_tattico": 5},

    # --- LIGUE 1 ---
    "psg": {"allenatore": "Luis Enrique", "indice_tattico": 9},
    ...
    "lille": {"allenatore": "Bruno Génésio", "indice_tattico": 8},
    "lens": {"allenatore": "Will Still", "indice_tattico": 8},
    "nice": {"allenatore": "Franck Haise", "indice_tattico": 8},
    "rennes": {"allenatore": "Julien Stéphan", "indice_tattico": 7},
    "reims": {"allenatore": "Luka Elsner", "indice_tattico": 7},
    "strasbourg": {"allenatore": "Liam Rosenior", "indice_tattico": 6},
    "toulouse": {"allenatore": "Carles Martínez Novell", "indice_tattico": 6},
    "montpellier": {"allenatore": "Michel Der Zakarian", "indice_tattico": 5},
    "nantes": {"allenatore": "Antoine Kombouaré", "indice_tattico": 5},
    "brest": {"allenatore": "Éric Roy", "indice_tattico": 8},
    "auxerre": {"allenatore": "Christophe Pélissier", "indice_tattico": 6},
    "angers": {"allenatore": "Alexandre Dujeux", "indice_tattico": 5},
    "le havre": {"allenatore": "Didier Digard", "indice_tattico": 6},
